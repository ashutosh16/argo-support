...
export const Summary = (summaryProps: SummarysProps) => {
    ...
    useEffect(() => {
        const fetchGenAIData = async () => {
           ...
           console.log("Fetching GenAI data");
             ...
             <div>App is healthy. No GenAI summary to display</div>:
               <React.Fragment>
                <div className="summary">
                    ...
                    {  phase!== "completed" ?
                        phase === "failed" ?
                            <div className="summary__container-main">Retrying..</div>
                            : phase === "error" ?
                                <div className="summary__container-main">Failed to fetch the summary, try after sometime.
                                </div>
                                :<div className="summary_container-main">
                        ...
                        <div className="summary__container-main">
                            <div className="summary__analysis-title">Analysis
                            ...
                            {result.summary.mainSummary.split('-/-/-/-').map((part, index) => (
                                        ...
                                        <>
                                            <ul style={{paddingLeft: '20px'}}>
                                                {part
                                                    ...
                                                    .map((statement, index) => (
                                                        statement.length > 0 && <li key={index}>{statement}</li>
                                                    ))}
                                            </ul>
                                            <span style={{ fontSize: '10px', fontWeight: 100, paddingLeft: '20px' }}>
